...
export default function OSStartMenu({ isOpen, onClose, onOpenApp }: OSStartMenuProps) {
  ...
  className="absolute bottom-16 left-2 w-[420px] bg-[#1a2536]/95 backdrop-blur-xl  border border-white/10 shadow-2xl overflow-hidden"
  style={{ zIndex: 9001 }}
  >
  <div className="p-4 pb-3">
  <div className="flex items-center gap-2 bg-white/10  px-3 h-9">
  ...
  className="flex flex-col items-center gap-1.5 p-3  hover:bg-white/10 transition-colors"
  >
  ...
  className="flex items-center gap-1.5 px-3 h-8  text-xs text-gray-400 hover:bg-white/10 hover:text-white transition-colors"
  >
