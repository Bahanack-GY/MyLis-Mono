...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
  <div className="bg-white border border-gray-100  px-3 py-2 shadow-lg text-xs">
...
export default function TaskTimeChart({ employeeId }: Props) {
  ...
  className="flex-1 px-2 py-1.5 border border-gray-200  text-xs focus:outline-none focus:border-[#33cbcc]"
  />
