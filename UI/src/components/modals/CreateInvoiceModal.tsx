...
export const CreateInvoiceModal = ({ onClose, isProforma = false }: { onClose: () => void; isProforma?: boolean }) => {
  ...
  {isProforma ? 'Proforma' : t('invoices.create.title', 'Invoice')}
  </p>
  <h2 className="text-lg font-bold text-[#1c2b3a] leading-none">
  {isProforma ? 'Nouvelle Proforma' : t('invoices.create.title')}
  </h2>
  </div>
  ...
  <div className="px-4 py-3 bg-[#f8f9fc] border border-[#e5e8ef] text-sm text-[#8892a4]">
  ...
  className="flex items-center gap-1 text-xs font-semibold text-[#8892a4] hover:text-[#1c2b3a] transition-colors border border-dashed border-[#e5e8ef] hover:border-[#283852] px-2.5 py-1"
  >
  <Add01Icon size={12} />
  ...
  <div className="flex gap-2 mb-2 text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider px-1 min-w-max">
  ...
  className="w-full bg-transparent border-b border-dashed border-[#e5e8ef] focus:border-[#33cbcc] focus:outline-none text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider py-0.5 transition-colors"
  />
  <button
  type="button"
  onClick={() => removeCustomColumn(col.id)}
  className="opacity-0 group-hover:opacity-100 text-[#b0bac9] hover:text-[#283852] transition-all shrink-0"
  >
  ...
  const cellCls = "w-full bg-[#f8f9fc] border border-[#e5e8ef] px-3 py-2 text-xs text-[#1c2b3a] placeholder-[#b0bac9] focus:outline-none focus:border-[#33cbcc] focus:bg-white transition-colors";
  return (
  ...
  <div className="w-24 shrink-0 text-xs font-medium text-[#1c2b3a] px-1">
  ...
  className="w-24 bg-[#f8f9fc] border border-[#e5e8ef] px-3 py-2 text-xs text-[#1c2b3a] focus:outline-none focus:border-[#33cbcc] focus:bg-white transition-colors"
  />
  </div>
  ...
  <div className="flex justify-between text-base font-bold text-[#1c2b3a] pt-2 border-t border-[#e5e8ef]">
