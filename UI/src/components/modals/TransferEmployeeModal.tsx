...
const TransferEmployeeModal = ({ open, onClose, employee }: TransferEmployeeModalProps) => {
  ...
  <div className="flex items-center gap-2 p-3 bg-[#283852]/10  border border-gray-200">
  ...
  required
  className="w-full p-3 border border-gray-200  focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc] outline-none"
  >
  ...
  <div className="flex items-start gap-3 p-4 bg-[#283852]/10 border border-gray-200 ">
  ...
  className="px-4 py-2 bg-[#33cbcc] text-white  hover:bg-[#2bb5b6] disabled:opacity-50 disabled:cursor-not-allowed"
  >
