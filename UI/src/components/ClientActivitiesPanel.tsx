...
export default function ClientActivitiesPanel({ clientId }: { clientId: string }) {
  ...
  <div className={`inline-flex items-center gap-2 px-3 py-1.5  ${healthStyles.bg} ${healthStyles.text}`}>
  <HealthIcon size={16} />
  ...
  <button
  className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-[#33cbcc]  hover:bg-[#33cbcc]/90 transition-colors shadow-sm"
  onClick={() => {
  ...
  <div className="mt-2 p-2 bg-[#33cbcc]/10 ">
  ...
  {activity.nextAction && (
  <div className="mt-2 p-2 bg-[#283852]/10 ">
