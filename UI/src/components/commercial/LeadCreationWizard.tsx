...
const inputCls = 'w-full px-4 py-2.5 bg-gray-50 border border-gray-200  focus:ring-2 focus:ring-[#33cbcc]/20 focus:border-[#33cbcc] transition-colors outline-none text-gray-800 text-sm';
...
export default function LeadCreationWizard({ onClose }: { onClose: () => void }) {
  ...
  className="fixed inset-x-0 bottom-16 sm:bottom-auto sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-2xl max-h-[calc(100vh-4rem)] sm:max-h-[92vh] bg-white   shadow-2xl z-[60] flex flex-col overflow-hidden"
  >
  {/* ── Header ── */}
  ...
  <button onClick={onClose} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100  transition-colors">
  ...
  key={s.key}
  onClick={() => goTo(i)}
  className={`flex-1 flex flex-col items-center gap-1 px-2 py-2  text-xs font-medium transition-all ${
  isActive
  ...
  <button
  onClick={addContact}
  className="flex items-center gap-1.5 text-xs font-semibold text-[#33cbcc] hover:bg-[#33cbcc]/10 px-3 py-1.5  transition-colors"
  >
  <Add01Icon size={13} />
  ...
  animate={{ opacity: 1, y: 0 }}
  className={` border p-4 space-y-3 ${c.isPrimary ? 'border-[#33cbcc]/40 bg-[#33cbcc]/5' : 'border-gray-200 bg-white'}`}
  >
  ...
  className={`p-1.5  transition-colors ${c.isPrimary ? 'text-[#33cbcc]' : 'text-gray-300 hover:text-[#33cbcc]'}`}
  >
  ...
  className="p-1.5 text-gray-300 hover:text-[#283852] hover:bg-[#283852]/10  transition-colors"
  >
  ...
  {n.serviceId ? (
  <div className="flex items-center gap-2">
  <span className="flex-1 px-3 py-2  bg-[#33cbcc]/10 text-[#33cbcc] text-sm font-medium">
  {activeServices.find(s => s.id === n.serviceId)?.name ?? n.serviceId}
  </span>
  <button
  onClick={() => updateNeed(i, 'serviceId', null)}
  className="p-2 text-gray-400 hover:text-[#283852]  transition-colors"
  >
  ...
  <p className="text-xs text-amber-500 bg-amber-50 border border-amber-200  px-3 py-2">
  ...
  <div className="flex items-center gap-2 px-4 py-2.5 bg-[#283852]/10 border border-gray-200 ">
  ...
  {/* Summary card */}
  <div className="mt-2 bg-gray-50  border border-gray-100 p-4">
  ...
  onClick={goPrev}
  disabled={step === 0}
  className="flex items-center gap-1.5 px-3 sm:px-4 py-2.5  text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
  >
  ...
  <button
  onClick={goNext}
  className="flex items-center gap-1.5 px-3 sm:px-4 py-2.5  text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2bb5b6] transition-colors shadow-lg shadow-[#33cbcc]/20"
  >
  ...
  className={`flex items-center gap-2 px-4 sm:px-5 py-2.5  text-sm font-semibold text-white transition-colors shadow-lg shadow-[#33cbcc]/20 ${
