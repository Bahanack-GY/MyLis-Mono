...
const Header = ({ onMobileMenuOpen }: { onMobileMenuOpen?: () => void }) => {
  ...
  className="md:hidden p-1.5  text-gray-500 hover:bg-gray-100 transition-colors"
  >
  ...
  className="w-full bg-[#f5f6fa] border border-[#e5e8ef]  py-3.5 pl-11 pr-4 text-sm text-[#1c2b3a] placeholder-[#b0bac9] focus:outline-none focus:border-[#33cbcc] transition-colors"
  />
  </div>
  </div>
  ...
  className="flex items-center gap-2 md:gap-3 cursor-pointer hover:bg-gray-50 p-1.5 md:p-2  transition-colors"
  >
