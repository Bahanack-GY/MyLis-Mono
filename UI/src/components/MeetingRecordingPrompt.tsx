...
const MeetingRecordingPrompt = () => {
  ...
  className="fixed bottom-6 right-6 z-[150] bg-white  shadow-2xl border border-gray-100 p-4 w-80"
  >
  {state === 'prompted' && (
  <>
  ...
  className="w-full flex items-center justify-center gap-2 bg-[#33cbcc] text-white py-2.5  text-sm font-semibold hover:bg-[#2bb5b6] transition-colors shadow-lg shadow-[#33cbcc]/20"
  >
  <Mic01Icon size={15} />
  Start Recording
  </button>
  ...
  className="w-full flex items-center justify-center gap-2 bg-[#283852] text-white py-2.5  text-sm font-semibold hover:bg-[#283852]/90 transition-colors"
  >
  <SquareIcon size={13} />
  Stop & Upload01Icon
  </button>
  ...
  <div className="w-10 h-10  bg-[#33cbcc]/10 flex items-center justify-center mx-auto mb-3">
