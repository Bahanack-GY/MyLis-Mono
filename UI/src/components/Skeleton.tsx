...
const Bone = ({ className = '', style }: { className?: string; style?: CSSProperties }) => (
  <div className={`animate-pulse bg-gray-100  ${className}`} style={style} />
);
...
const SearchBar = ({ hasButton = false }: { hasButton?: boolean }) => (
  ...
  {hasButton && <Bone className="h-10 w-28 " />}
  </div>
);
...
const KanbanColumn = () => (
  ...
  <div key={i} className="bg-white  p-4 space-y-2.5 border border-gray-100">
...
const CardGrid = ({ count = 4, cols = 2 }: { count?: number; cols?: number }) => (
  ...
  {Array.from({ length: count }).map((_, i) => (
  <div key={i} className="bg-white p-5  border border-gray-100 space-y-4">
  <div className="flex items-center gap-3">
...
const ChartBox = ({ height = 200 }: { height?: number }) => (
  <div className="bg-white p-5  border border-gray-100 space-y-3">
...
export const UserDocumentsSkeleton = () => (
  ...
  <SearchBar />
  <Bone className="h-10 w-20  shrink-0" />
  </div>
  <FilterPills count={6} />
  <CardGrid count={6} cols={3} />
  </div>
...
export const UserDemandsSkeleton = () => (
  ...
  <div className="flex gap-2">
  {Array.from({ length: 4 }).map((_, i) => <Bone key={i} className="h-10 w-28 " />)}
  </div>
  <CardGrid count={6} cols={3} />
  </div>
);
...
export const UserNotificationsSkeleton = () => (
  ...
  <Bone className="h-10 flex-1  min-w-[200px]" />
  <FilterPills count={3} />
  </div>
  <FilterPills count={8} />
  <NotifList count={8} />
...
export const UserProfileSkeleton = () => (
  ...
  {Array.from({ length: 9 }).map((_, i) => <Bone key={i} className="h-14 " />)}
  </div>
  </div>
  <div className="space-y-4">
  <div className="bg-white p-5  border border-gray-100 space-y-3">
...
export const UserMessagesSkeleton = () => (
  <div className="flex h-[calc(100vh-140px)] bg-white  border border-gray-100 overflow-hidden">
  ...
  <Bone className={`h-10  ${own ? 'w-44' : 'w-56'}`} />
  </div>
  </div>
  ))}
  </div>
...
export const MessagesSkeleton = () => (
  ...
  <Bone className={`h-3.5 ${own ? 'w-16' : 'w-20'}`} />
  <Bone className={`h-12  ${own ? 'w-48' : 'w-60'}`} />
  </div>
  </div>
  ))}
  </div>
