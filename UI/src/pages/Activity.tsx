...
const ActivityPage = () => {
  ...
  const selectCls = 'bg-white  border border-gray-200 px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc] transition-all appearance-none cursor-pointer';
  ...
  alt=""
  className="w-10 h-10  border border-gray-200 object-cover shrink-0"
  />
  ) : (
  ...
  disabled={page === 1}
  className="flex items-center gap-1.5 px-4 py-2  border border-gray-200 text-sm font-medium text-gray-600 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
  >
