...
const Notifications = () => {
  ...
  <div className="flex bg-white  border border-gray-100 p-1">
  {readFilters.map(rf => (
  <button
  key={rf.key}
  ...
  {/* Type icon */}
  <div className="w-9 h-9  flex items-center justify-center shrink-0 mt-0.5" style={{ backgroundColor: `${typeColor}15` }}>
