...
const Dashboard = () => {
  ...
  className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200  text-gray-700 font-medium hover:bg-gray-50 hover:border-[#33cbcc]/40 transition-colors"
  >
  ...
  className="absolute right-0 top-full mt-2 bg-white  border border-gray-200 shadow-xl z-50 min-w-[220px] overflow-hidden"
  >
  ...
  className="w-full mt-1 px-3 py-2 bg-[#33cbcc] text-white text-sm font-semibold  hover:bg-[#2bb5b6] transition-colors"
  >
  ...
  className={`border border-gray-100  overflow-hidden transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#33cbcc]/40 hover:border-[#33cbcc]/50${stat.link ? ' cursor-pointer' : ''}`}
  >
  ...
  <div className="w-3 h-3 " style={{ background: 'linear-gradient(to right, #33cbcc, #33cbcc80)' }} />
  <span>{t('dashboard.charts.projects', 'Projects')}</span>
  </div>
  <div className="flex items-center gap-1.5">
  <div className="w-3 h-3  bg-[#283852] opacity-70" />
