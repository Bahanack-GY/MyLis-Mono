...
const ValidationModal = ({
  ...
  <span className="text-xs text-[#8892a4] uppercase tracking-wider">{t('businessExpenses.table.employee')}</span>
  <span className="text-sm font-medium text-[#1c2b3a]">
  {expense.employee ? `${expense.employee.firstName} ${expense.employee.lastName}` : '\u2014'}
  </span>
  </div>
  <div className="flex items-center justify-between">
  <span className="text-xs text-[#8892a4] uppercase tracking-wider">{t('businessExpenses.amount')}</span>
  <span className="text-sm font-bold text-[#1c2b3a]">{formatFCFA(expense.amount)}</span>
  </div>
  {expense.expenseType && (
  <div className="flex items-center justify-between">
  <span className="text-xs text-[#8892a4] uppercase tracking-wider">{t('businessExpenses.type')}</span>
  <span className="inline-flex items-center gap-1.5 text-sm text-[#1c2b3a]">
  ...
  <div className="flex items-center justify-between">
  <span className="text-xs text-[#8892a4] uppercase tracking-wider">{t('businessExpenses.date')}</span>
  <span className="text-sm text-[#8892a4]">{formatDate(expense.date)}</span>
  </div>
  </div>
  ...
  <div className="px-6 py-4 border-t border-[#e5e8ef] flex items-center gap-3">
  <button
  onClick={onCancel}
...
const DetailModal = ({
  ...
  <img src={expense.employee.avatarUrl} alt="" className="w-10 h-10 rounded-full border border-[#e5e8ef] object-cover" />
  ) : (
  <div className="w-10 h-10 rounded-full bg-[#f8f9fc] border border-[#e5e8ef] flex items-center justify-center">
  ...
  <p className="text-xs text-[#8892a4]">{t('businessExpenses.requestedBy')}</p>
  </div>
  </div>
  ...
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1">{t('businessExpenses.amount')}</p>
  <p className="text-lg font-bold text-[#1c2b3a]">{formatFCFA(expense.amount)}</p>
  </div>
  <div className="bg-[#f8f9fc] p-3">
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1">{t('businessExpenses.date')}</p>
  <p className="text-lg font-bold text-[#1c2b3a]">{formatDate(expense.date)}</p>
  </div>
  <div className="bg-[#f8f9fc] p-3">
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1">{t('businessExpenses.type')}</p>
  {expense.expenseType ? (
  <span className="inline-flex items-center gap-1.5 text-sm font-medium text-[#1c2b3a]">
  <span className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: expense.expenseType.color || '#33cbcc' }} />
  {expense.expenseType.name}
  </span>
  ) : (
  <span className="text-sm text-[#8892a4]">{'\u2014'}</span>
  )}
  </div>
  <div className="bg-[#f8f9fc] p-3">
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1">{t('businessExpenses.table.status')}</p>
  ...
  {expense.description && (
  <div>
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1.5">{t('businessExpenses.description')}</p>
  <p className="text-sm text-[#8892a4] leading-relaxed bg-[#f8f9fc] p-3">{expense.description}</p>
  </div>
  )}
  ...
  <p className="text-sm text-[#283852] leading-relaxed bg-[#283852]/10  p-3">{expense.rejectionReason}</p>
  </div>
  )}
  ...
  {receiptUrl && (
  <div>
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1.5">{t('businessExpenses.receipt')}</p>
  <a
  href={receiptUrl}
  target="_blank"
  rel="noopener noreferrer"
  className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-[#33cbcc] bg-[#33cbcc]/10 hover:bg-[#33cbcc]/20 transition-colors"
  >
  <ViewIcon size={16} />
...
const RejectionModal = ({
  ...
  <div className="p-6 space-y-4 flex-1 overflow-y-auto">
  <div>
  <label className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1.5 block">
  ...
  disabled={isLoading}
  className="flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold text-white bg-[#283852] hover:bg-[#1e2d42] transition-colors disabled:opacity-50"
  >
  {isLoading ? (
  <Loading02Icon size={16} className="animate-spin" />
  ) : (
...
const BusinessExpenses = () => {
  ...
  className="p-2.5  bg-white border border-gray-200 hover:bg-gray-50 hover:border-[#33cbcc]/40 text-gray-500 hover:text-[#33cbcc] transition-colors"
  ...
  className="bg-white p-5  border border-gray-100 relative overflow-hidden group"
  >
  ...
  className="px-4 py-2.5 border border-gray-200  text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/20 focus:border-[#33cbcc] transition-all bg-white"
  >
  ...
  className="pl-9 pr-3 py-2.5 border border-gray-200  text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/20 focus:border-[#33cbcc] transition-all bg-white"
  />
  </div>
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="inline-flex items-center gap-1.5 px-2.5 py-1.5  text-xs font-medium text-[#33cbcc] bg-[#33cbcc]/10 hover:bg-[#33cbcc]/20 transition-colors"
  ...
  className="p-2  text-[#33cbcc] bg-[#33cbcc]/10 hover:bg-[#33cbcc]/20 transition-colors"
  ...
  className="p-2  text-[#283852] bg-[#283852]/10 hover:bg-[#283852]/20 transition-colors"
