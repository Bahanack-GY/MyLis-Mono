...
function LogActivityModal({
  ...
  className="fixed inset-x-0 bottom-0 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-lg bg-white   shadow-2xl z-[60] overflow-hidden"
  >
  ...
  <button onClick={onClose} className="p-1.5  hover:bg-gray-100 text-gray-400">
  ...
  className="w-full px-3 py-2 border border-gray-200  text-sm focus:outline-none focus:border-[#33cbcc] placeholder-gray-300" />
  </div>
  </div>
  ...
  className="w-full px-3 py-2 border border-gray-200  text-sm focus:outline-none focus:border-[#33cbcc] placeholder-gray-300 resize-none" />
  </div>
  ...
  className="flex-1 px-4 py-2.5  text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors">
  Annuler
  </button>
  <button onClick={submit} disabled={create.isPending || !form.date}
  className="flex-1 px-4 py-2.5  text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2bb5b6] transition-colors disabled:opacity-50 flex items-center justify-center gap-2">
...
function LeadCard({
  ...
  <button
  onClick={onLog}
  className="shrink-0 w-7 h-7  bg-[#33cbcc]/10 hover:bg-[#33cbcc]/20 text-[#33cbcc] flex items-center justify-center transition-colors"
...
function ActivityPanel({
  ...
  <button onClick={onBack} className="md:hidden p-1.5  hover:bg-gray-100 text-gray-500">
  ...
  <button
  onClick={onLog}
  className="shrink-0 flex items-center gap-1.5 px-3 py-1.5  bg-[#33cbcc] text-white text-xs font-semibold hover:bg-[#2bb5b6] transition-colors"
  >
  <Add01Icon size={13} />
...
export default function LeadFollowUp() {
  ...
  className="hidden sm:block px-3 py-2 bg-white border border-gray-200  text-sm text-gray-700 focus:outline-none focus:border-[#33cbcc] transition-colors">
  ...
  className="px-2 py-1.5 bg-gray-50 border border-gray-200  text-xs text-gray-700 focus:outline-none focus:border-[#33cbcc] transition-colors"
  />
  ...
  <select value={stageFilter} onChange={e => setStageFilter(e.target.value)}
  className="w-full px-3 py-2 bg-gray-50 border border-gray-100  text-sm text-gray-700 focus:outline-none focus:border-[#33cbcc]">
  <option value="">Tous les stades</option>
  {stages.map(s => (
  <option key={s} value={s}>{STAGE_LABEL[s]}</option>
  ))}
  ...
  disabled={page <= 1}
  className="flex items-center gap-1 px-2.5 py-1.5  text-xs font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
  >
