...
export default function CommercialDashboard() {
  ...
  className="px-3 py-2 bg-white border border-gray-200  text-sm text-gray-700 focus:outline-none focus:border-[#33cbcc] hover:border-[#33cbcc]/40 transition-colors"
  >
  ...
  className="px-4 py-2.5 bg-gray-50 border border-gray-200  text-sm focus:ring-2 focus:ring-[#33cbcc]/20 focus:border-[#33cbcc] outline-none transition-all"
  />
  <input
  type="date"
  value={customTo}
  ...
  className="p-1.5  hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors disabled:opacity-30"
  ...
  autoFocus
  placeholder="0"
  className="w-32 text-right text-sm border border-gray-200  px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc]"
  />
  <button
  ...
  className="px-3 py-1.5  bg-[#33cbcc]/10 text-[#33cbcc] hover:bg-[#33cbcc] hover:text-white text-xs font-semibold transition-colors whitespace-nowrap"
  >
