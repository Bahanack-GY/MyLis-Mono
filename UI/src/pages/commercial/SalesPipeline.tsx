...
const PipelineEditModal = ({
  ...
  const sectionCls = 'border-t border-[#e5e8ef] pt-5';
  ...
  <p className="text-xs text-[#8892a4]">{lead.code} - {lead.company}</p>
  </div>
  </div>
  ...
  {/* Section: Pipeline */}
  <div>
  <h3 className="text-sm font-bold text-[#1c2b3a] mb-4">{t('commercial.pipeline.sectionPipeline')}</h3>
  ...
  <h3 className="text-sm font-bold text-[#1c2b3a] mb-4">{t('commercial.pipeline.sectionCompetition')}</h3>
  ...
  {/* Section: Actions */}
  <div className={sectionCls}>
  <h3 className="text-sm font-bold text-[#1c2b3a] mb-4">{t('commercial.pipeline.sectionActions')}</h3>
  <div className="grid grid-cols-2 gap-4">
  <div>
  ...
  <div className={sectionCls}>
  <h3 className="text-sm font-bold text-[#1c2b3a] mb-4">{t('commercial.pipeline.sectionQuickActivity')}</h3>
  <div className="grid grid-cols-2 gap-4">
  <div>
  ...
  ? 'bg-[#f8f9fc] text-[#1c2b3a] hover:bg-[#e5e8ef]'
  : 'bg-[#f8f9fc] text-[#b0bac9] cursor-not-allowed'
  }`}
  >
  ...
  return (
  <div key={task.id} className="flex items-center justify-between p-2.5 bg-[#f8f9fc]">
  <div className="flex items-center gap-2 min-w-0">
  <span className={`px-2 py-0.5 text-[10px] font-semibold ${stateColors[task.state] || 'bg-[#f8f9fc] text-[#8892a4]'}`}>
  {task.state}
  </span>
  <span className="text-sm text-[#1c2b3a] truncate">{task.title}</span>
  </div>
  {task.dueDate && (
  <span className="text-[10px] text-[#8892a4] shrink-0 ml-2">
  ...
  <p className="text-xs text-[#8892a4]">{t('commercial.leads.noLinkedTasks', 'Aucune tache liee')}</p>
  )}
  </div>
  </div>
  ...
  onClick={handleSave}
  className="flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2bb5b6] transition-colors"
  >
...
function QuickLogActivityModal({ lead, type, onClose }: { lead: Lead, type: ActivityType, onClose: () => void }) {
  ...
  <button onClick={onClose} className="text-[#8892a4] hover:text-[#1c2b3a] transition-colors"><Cancel01Icon size={18} /></button>
  </div>
  ...
  <div className="px-5 py-4 border-t border-[#e5e8ef] flex gap-3 shrink-0">
...
const QuickStageDropdown = ({
  ...
  exit={{ opacity: 0, y: -4 }}
  className="absolute z-40 top-full left-0 mt-1 bg-white  border border-gray-100 py-1 min-w-[160px] shadow-lg"
  >
  {ALL_STAGES.map(s => {
...
const PipelineDashboard = ({
  ...
  const selectCls = 'px-3 py-2 bg-white border border-gray-200  text-sm text-gray-600 focus:ring-2 focus:ring-[#33cbcc]/20 focus:border-[#33cbcc] outline-none transition-all appearance-none cursor-pointer';
  ...
  className="bg-white  sm border border-gray-100 p-5  transition-shadow"
  >
  <div className="flex items-start justify-between mb-3">
  <div className={`p-2.5  ${kpi.bgLight}`}>
  ...
  className="bg-white  sm border border-gray-100 p-5 flex items-center gap-4"
  >
  ...
  className="bg-white  sm border border-gray-100 p-5 flex items-center gap-4"
  >
  <div className="p-3  bg-[#33cbcc]/10">
  ...
  className="bg-white  sm border border-gray-100 p-6"
  >
  ...
  className="w-full  bg-gradient-to-t from-[#33cbcc] to-[#33cbcc]/60 hover:from-[#2bb5b6] hover:to-[#33cbcc] transition-colors cursor-default"
...
const SalesPipeline = () => {
  ...
  <ToggleSwitch
    ...
    onChange={v => setView(v ? 'dashboard' : 'table')}
    labels={[t('commercial.pipeline.viewTable'), t('commercial.pipeline.viewDashboard')]}
  />
  </div>
  ...
  className={`bg-white  sm border p-4 text-left transition-all  ${
  ...
  className="flex items-center gap-1.5 px-3 py-2  text-xs font-medium bg-[#33cbcc]/10 text-[#33cbcc] hover:bg-[#33cbcc]/20 transition-colors shrink-0"
  >
  ...
  {/* ── Table ── */}
  <div className="bg-white  sm border border-gray-100 overflow-hidden">
  {/* Table Header */}
  ...
  className="p-1.5  hover:bg-gray-100 text-gray-400 hover:text-[#33cbcc] transition-colors"
  ...
  disabled={page <= 1}
  className="p-2  border border-gray-200 text-gray-400 hover:text-gray-600 hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
  >
