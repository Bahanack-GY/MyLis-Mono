...
const OverviewView = ({ client }: { client: ClientData }) => {
  ...
  className="bg-white p-6  border border-gray-100 space-y-4"
  >
...
const InvoicesView = ({ client }: { client: ClientData }) => {
  ...
  className="bg-white  border border-gray-100 p-5 hover:border-gray-200 transition-colors"
  >
...
const SettingsView = ({ client }: { client: ClientData }) => {
  ...
  const selectCls = 'w-full bg-white  border border-gray-200 px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc] transition-all appearance-none cursor-pointer';
  ...
  initial={{ opacity: 0, y: 20 }}
  animate={{ opacity: 1, y: 0 }}
  className="bg-white  border border-gray-100 p-6 space-y-5"
  >
