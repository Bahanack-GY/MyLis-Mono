...
const ChartTooltip = ({ active, payload, label }: any) => {
  ...
  return (
  <div className="bg-white border border-gray-100  shadow-lg p-3 text-sm">
...
export default function CashFlow() {
  ...
  <div className="flex items-center gap-2 bg-white border border-gray-200  px-4 py-2.5">
  ...
  className={` border p-5 ${data.netCashFlow >= 0 ? 'bg-[#33cbcc]/5 border-[#33cbcc]/30' : 'bg-[#283852]/5 border-gray-200'}`}
  >
  <div className="flex items-center gap-3 mb-3">
  <div className={`w-10 h-10  flex items-center justify-center ${data.netCashFlow >= 0 ? 'bg-[#33cbcc]/20' : 'bg-[#283852]/20'}`}>
  ...
  <div className="flex items-center gap-1 p-1 bg-white border border-gray-200 ">
  ...
  className="flex items-center gap-1 px-3 py-1.5 text-xs text-gray-500 hover:text-[#283852] border border-gray-200  transition-colors"
  >
