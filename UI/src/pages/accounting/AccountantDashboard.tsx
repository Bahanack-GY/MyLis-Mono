...
const KpiCard = ({ label, value, delta, icon: Icon, index, accent, onClick }: KpiCardProps) => (
    <motion.div
        ...
        animate="visible"
        onClick={onClick}
        className={`border border-[#e5e8ef] rounded-2xl overflow-hidden group hover:border-[#33cbcc] transition-colors ${onClick ? 'cursor-pointer' : ''}`}
    >
    ...
    >
        <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-2">
                {Icon && (
                    <div className="w-7 h-7 rounded-lg bg-[#33cbcc]/10 flex items-center justify-center">
        ...
        return (
            <div className="space-y-6 animate-pulse">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div className="bg-white rounded-2xl p-5 h-80 lg:col-span-2" />
        ...
        <div className="space-y-5">
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <select
                        ...
                        className="px-3 py-2 bg-white border border-gray-200 rounded-xl text-sm text-gray-700 focus:ring-2 focus:ring-[#33cbcc]/20 focus:border-[#33cbcc] outline-none cursor-pointer"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <Section title="Plan comptable" subtitle="Comptes actifs" icon={BookOpen01Icon} delay={2}>
                    ...
                    <button
                        onClick={() => navigate('/accounting/accounts')}
                        className="mt-3 w-full flex items-center justify-center gap-1 text-[11px] font-semibold text-[#33cbcc] hover:text-[#2bb5b6] py-2 rounded-lg hover:bg-[#33cbcc]/5 transition-colors"
                    >
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            return (
                                <div
                                    key={row.label}
                                    className="flex items-center justify-between p-2.5 rounded-lg bg-gray-50/60"
                                >
                                    <div className="flex items-center gap-2">
                                        <div
                ...
                >
                    <div className="grid grid-cols-2 gap-3">
                        {[
                            ...
                            <div
                                key={r.label}
                                className="p-2.5 rounded-lg bg-gray-50/60 border border-gray-100"
                            >
                        ...
                        {recentEmployees.map((emp: any, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="flex flex-col items-center text-center gap-2 p-3 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors border border-transparent hover:border-gray-100"
                                >
                                    <img
