...
const AIReports = () => {
  ...
  return (
  <div className="flex items-center gap-3 p-6 bg-[#283852]/10 ">
  ...
  return (
  <div className="flex items-center gap-3 p-6 bg-gray-100 ">
  ...
  className="flex items-center gap-2 px-4 py-2 bg-[#33cbcc] text-white  hover:bg-[#2bb5b6] transition-colors"
  >
  ...
  <div className="p-4 bg-white  border-2 border-gray-200 hover:border-[#33cbcc] transition-colors">
  ...
  className="flex items-center gap-2 px-6 py-3 bg-[#33cbcc] text-white  hover:bg-[#2bb5b6] transition-colors shadow-lg"
  >
  <Add01Icon size={20} />
  ...
  <div className="text-center p-12 bg-gray-50  border-2 border-dashed">
  ...
  <div key={report.id} className="bg-white border  p-6 shadow-sm">
  ...
  <h2 className="text-lg font-bold text-[#1c2b3a]">{t('accounting.aiReports.generate')}</h2>
  <button onClick={() => setShowGenerateForm(false)} className="text-[#8892a4] hover:text-[#1c2b3a] transition-colors">
  ...
  />
  <span className="text-sm text-[#1c2b3a]">{t('accounting.aiReports.includeBudget')}</span>
  </label>
  <label className="flex items-center gap-2">
  <input
  type="checkbox"
  ...
  className="w-4 h-4 text-[#33cbcc] border-gray-300 rounded focus:ring-[#33cbcc]"
  />
  <span className="text-sm text-[#1c2b3a]">{t('accounting.aiReports.includeTax')}</span>
  </label>
  </div>
