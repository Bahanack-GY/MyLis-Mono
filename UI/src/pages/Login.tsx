...
const Login = () => {
  ...
  const inputCls = 'w-full px-4 py-3.5  bg-gray-50 border border-gray-200 focus:border-[#33cbcc] focus:ring-2 focus:ring-[#33cbcc]/20 focus:bg-white transition-all outline-none text-gray-700 placeholder-gray-400 text-sm';
  ...
  className="flex-1 bg-white [80px] flex flex-col px-8 pt-16 pb-8"
  >
  ...
  className="w-full px-4 py-3  bg-gray-50 border-none focus:ring-2 focus:ring-[#33cbcc]/20 focus:bg-white transition-all outline-none text-gray-700 placeholder-gray-400"
  />
  </div>
  <div className="space-y-2">
  ...
  className="w-full px-4 py-3  bg-gray-50 border-none focus:ring-2 focus:ring-[#33cbcc]/20 focus:bg-white transition-all outline-none text-gray-700 placeholder-gray-400 pr-10"
  />
  <button
  type="button"
  ...
  whileTap={{ scale: 0.98 }}
  className="w-full text-white py-4  font-semibold mt-8 shadow-lg shadow-black/20 disabled:opacity-60"
  ...
  >
  <div className="w-12 h-12  bg-white flex items-center justify-center shadow-md">
  ...
  className="w-[500px] bg-white  shadow-2xl shadow-black/50 relative overflow-hidden"
  >
  ...
  animate={{ opacity: 1, y: 0 }}
  className="text-red-600 text-sm bg-red-50 border border-red-100  px-4 py-3"
  >
  ...
  whileHover={{ scale: 1.02, filter: 'brightness(1.1)' }}
  whileTap={{ scale: 0.98 }}
  className="w-full flex items-center justify-center gap-2 py-4  font-semibold text-white text-sm shadow-lg shadow-black/20 disabled:opacity-60 transition-all mt-2"
  style={{ backgroundColor: '#283852' }}
  >
  {login.isPending ? (
