...
const EditProfileModal = ({
  ...
  <h2 className="text-lg font-bold text-[#1c2b3a]">{t('profile.editProfile')}</h2>
  </div>
  ...
  <span
  key={i}
  className="flex items-center gap-1.5 px-3 py-1.5  text-sm font-medium bg-[#33cbcc]/10 text-[#33cbcc] border border-[#33cbcc]/20"
  >
  {skill}
  <button
  type="button"
  ...
  className="shrink-0 w-10 h-10  bg-[#33cbcc] text-white flex items-center justify-center hover:bg-[#2bb5b6] transition-colors"
  >
  <Add01Icon size={18} />
  </button>
  </div>
...
const EducationSection = ({
  ...
  const inputCls = 'w-full bg-white  border border-gray-200 px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc] transition-all';
  ...
  className="bg-white   border border-gray-100 p-5 md:p-6"
  >
  ...
  {selectedFile ? (
  <div className="flex items-center gap-2 px-4 py-2.5 bg-white  border border-gray-200">
  ...
  <label className="flex items-center justify-center gap-2 px-4 py-3 bg-white  border border-dashed border-gray-300 cursor-pointer hover:border-[#33cbcc] hover:bg-[#33cbcc]/5 transition-all">
  ...
  className="flex items-center gap-1.5 px-4 py-2 bg-[#33cbcc] text-white  text-xs font-semibold hover:bg-[#2bb5b6] transition-colors disabled:opacity-50"
  >
  ...
  >
  <div className={`w-10 h-10  flex items-center justify-center shrink-0 ${EDU_TYPE_COLORS[doc.type] || EDU_TYPE_COLORS.other}`}>
  ...
  className="p-1.5 text-gray-300 hover:text-[#33cbcc] transition-colors  hover:bg-[#33cbcc]/10"
  >
  <ViewIcon size={16} />
  </a>
  )}
  ...
  className="opacity-0 group-hover:opacity-100 p-1.5 text-gray-300 hover:text-[#283852] transition-all  hover:bg-[#283852]/10"
  >
...
const Profile = () => {
  ...
  <div className="w-20 h-20 md:w-28 md:h-28  border-4 border-white shadow-xl overflow-hidden bg-white shrink-0">
  {profile.avatar ? (
  ...
  className="flex items-center justify-center gap-2 bg-[#33cbcc] text-white px-5 py-2.5  text-sm font-semibold hover:bg-[#2bb5b6] transition-colors shadow-lg shadow-[#33cbcc]/20 w-full md:w-auto"
  >
  <PencilIcon size={16} />
  ...
  className="px-4 py-2  text-sm font-medium bg-[#33cbcc]/10 text-[#33cbcc] border border-[#33cbcc]/20"
  >
  {skill}
  </motion.span>
  ))}
  ...
  return (
  <div className="mb-6 p-4  bg-[#33cbcc]/5 border border-[#33cbcc]/20">
  ...
  {/* Tooltip on hover */}
  <div className="absolute -top-10 left-1/2 -translate-x-1/2 px-2.5 py-1 bg-gray-800 text-white text-[10px]  whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
  ...
  <div className="w-7 h-7  bg-[#283852]/10 flex items-center justify-center">
  ...
  className="w-full px-3 py-2.5 pr-10 text-sm border border-gray-200  focus:outline-none focus:border-[#33cbcc] focus:ring-1 focus:ring-[#33cbcc]/20"
  />
  ...
  className="w-full px-3 py-2.5 text-sm border border-gray-200  focus:outline-none focus:border-[#33cbcc] focus:ring-1 focus:ring-[#33cbcc]/20"
  />
  ...
  className="px-4 py-2 text-xs font-semibold bg-[#283852] text-white  hover:bg-[#283852]/90 disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-1.5"
  >
