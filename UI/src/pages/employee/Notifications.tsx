...
const Notifications = () => {
  ...
  className="flex items-center justify-center gap-2 bg-[#283852] text-white px-5 py-2.5  text-sm font-semibold hover:bg-[#1e2d42] transition-colors w-full md:w-auto"
  >
  ...
  className="bg-white p-4 md:p-6  border border-gray-100 relative overflow-hidden group"
  >
  ...
  className={`bg-white  border p-4 md:p-5 transition-all cursor-pointer hover:border-[#33cbcc]/30 ${
