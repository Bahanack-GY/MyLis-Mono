...
const Dashboard = () => {
  ...
  className="border border-[#e5e8ef]  overflow-hidden cursor-pointer group hover:border-[#33cbcc] transition-colors"
  >
  ...
  className="bg-[#283852] border border-[#283852]  overflow-hidden"
  >
