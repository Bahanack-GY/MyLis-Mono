...
const CreateExpenseModal = ({ onClose }: { onClose: () => void }) => {
  ...
  <h2 className="text-lg font-bold text-[#1c2b3a]">{t('businessExpenses.newExpense')}</h2>
  </div>
  <button
  onClick={onClose}
  ...
  {receiptFile ? (
  <div className="flex items-center gap-3 p-3 bg-[#33cbcc]/5 border border-[#33cbcc]/20 ">
  <Attachment01Icon size={18} className="text-[#33cbcc] shrink-0" />
  <span className="text-sm text-[#1c2b3a] font-medium flex-1 truncate">
  {receiptFile.name}
  </span>
  {isUploading ? (
  ...
  className="p-1.5  text-[#8892a4] hover:text-[#283852] hover:bg-[#283852]/10 transition-colors shrink-0"
  >
  ...
  <label className="flex items-center gap-3 p-4 border-2 border-dashed border-[#e5e8ef] cursor-pointer hover:border-[#33cbcc]/40 hover:bg-[#33cbcc]/5 transition-all">
  <Upload01Icon size={20} className="text-[#8892a4]" />
  <span className="text-sm text-[#8892a4]">{t('businessExpenses.uploadReceipt')}</span>
  <span className="text-xs text-[#b0bac9] ml-auto">PDF, PNG, JPG</span>
  <input
  type="file"
  ...
  className="flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2ab5b6] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
  >
...
const BusinessExpenses = () => {
  ...
  className="flex items-center gap-2 px-5 py-3  text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2ab5b6] transition-all shadow-lg shadow-[#33cbcc]/20"
  >
  <Add01Icon size={18} />
  ...
  <div className="flex items-center gap-2 px-4 py-2  bg-[#283852]/10 border border-gray-200">
  ...
  <div className="flex items-center gap-2 px-4 py-2  bg-[#33cbcc]/10 border border-gray-200">
  ...
  <button
  onClick={() => setShowCreateModal(true)}
  className="mt-4 inline-flex items-center gap-2 px-5 py-2.5  text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2ab5b6] transition-all shadow-lg shadow-[#33cbcc]/20"
  >
  <Add01Icon size={16} />
  {t('businessExpenses.newExpense')}
  </button>
  ...
  className="bg-white  border border-gray-100  transition-all overflow-hidden"
  >
  <div className="p-5">
  ...
  className="p-2  text-gray-400 hover:text-[#283852] hover:bg-[#283852]/10 transition-colors disabled:opacity-50"
  >
  ...
  <div className="mt-3 bg-[#283852]/10 border border-gray-200  p-3">
