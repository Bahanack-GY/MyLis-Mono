...
const CreateFormationModal = ({ onClose }: { onClose: () => void }) => {
  ...
  <h2 className="text-lg font-bold text-[#1c2b3a]">{t('formations.create.title')}</h2>
  </div>
...
const FormationDetailModal = ({ formation, onClose }: { formation: Formation; onClose: () => void }) => {
  ...
  <h2 className="text-lg font-bold text-[#1c2b3a]">{formation.title}</h2>
  <button onClick={onClose} className="p-2 hover:bg-[#f8f9fc] text-[#8892a4] hover:text-[#1c2b3a] transition-colors">
  <Cancel01Icon size={18} />
  </button>
  </div>
  ...
  <div>
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider">{t('formations.detail.organization')}</p>
  <p className="text-sm font-medium text-[#1c2b3a] mt-0.5">{formation.organization}</p>
  </div>
  )}

  {(formation.startDate || formation.endDate) && (
  <div>
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider">{t('formations.detail.period')}</p>
  <p className="text-sm font-medium text-[#1c2b3a] mt-0.5">
  ...
  <div>
  <p className="text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider">{t('formations.detail.certificate')}</p>
  <p className="text-sm font-medium text-[#1c2b3a] mt-0.5">{formation.certificateDetails}</p>
  </div>
  )}
  </div>

  <div className="px-6 py-4 border-t border-[#e5e8ef] flex">
  <button onClick={onClose} className="flex-1 py-3 text-sm font-semibold text-[#8892a4] border border-[#e5e8ef] hover:border-[#283852] hover:text-[#283852] transition-colors">
...
const Formations = () => {
  ...
  className="bg-white  border border-gray-100 p-4 md:p-5 hover:border-[#33cbcc]/30 transition-all cursor-pointer"
  ...
  <button className="p-2  hover:bg-gray-100 text-gray-400 transition-colors shrink-0">
  <ViewIcon size={16} />
  </button>
  </div>
  </motion.div>
