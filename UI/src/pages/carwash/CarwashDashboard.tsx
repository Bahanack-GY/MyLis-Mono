...
export default function CarwashDashboard() {
  ...
  {/* Sync status */}
  <div className="flex items-center gap-1.5 text-xs text-gray-500 bg-gray-50  px-3 py-2">
  {syncStatus?.syncing ? (
  ...
  className="flex items-center gap-1.5 bg-[#33cbcc] text-white  px-4 py-2 text-sm font-medium hover:bg-[#2ab5b6] disabled:opacity-50 transition-colors"
  >
  ...
  className="appearance-none bg-white border border-gray-200  px-4 py-2 pr-8 text-sm text-[#283852] focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/40"
  >
  ...
  className={`px-3 py-1.5  text-sm font-medium transition-all ${uiPeriod === p.key ? 'bg-[#283852] text-white' : 'text-gray-600 hover:bg-gray-100'}`}>
  {p.label}
  </button>
  ))}
  <button onClick={() => handlePeriodChange('custom')}
  className={`px-3 py-1.5  text-sm font-medium transition-all ${uiPeriod === 'custom' ? 'bg-[#283852] text-white' : 'text-gray-600 hover:bg-gray-100'}`}>
  Personnalisé
  </button>
  </div>
  ...
  className="bg-white border border-gray-200  px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/40" />
  ...
  className="px-4 py-2 bg-[#283852] text-white text-sm font-semibold  hover:bg-[#1e2d43] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
  >
  Filtrer
  </button>
  </div>
  ...
  className={`flex items-center gap-1.5 px-4 py-2  text-sm font-medium transition-all ${tab === key ? 'bg-white text-[#283852] shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}>
  ...
  className="bg-white  shadow-md p-5 border border-gray-100">
