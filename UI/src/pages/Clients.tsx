...
import { Search01Icon, Add01Icon, Cancel01Icon, Building01Icon, UserCircleIcon, Briefcase01Icon, DollarCircleIcon, RefreshIcon, RepeatIcon, Loading02Icon, Delete02Icon, PencilIcon, ArrowUpRight01Icon } from 'hugeicons-react';
...
const Clients = () => {
  ...
  <div className="flex items-center gap-3">
  {!deptScope && (
  <div className="flex-1 bg-white  p-2 flex items-center border border-gray-100 shadow-sm min-w-0">
  ...
  <div className="w-12 h-12  bg-[#33cbcc]/10 flex items-center justify-center">
  ...
  onClick={e => handleDelete(e, client.id)}
  disabled={deleteClient.isPending}
  className="p-1.5  hover:bg-gray-100 text-gray-400 hover:text-[#283852] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
  >
  {deleteClient.isPending ? <Loading02Icon size={14} className="animate-spin" /> : <Delete02Icon size={14} />}
  </button>
  )}
