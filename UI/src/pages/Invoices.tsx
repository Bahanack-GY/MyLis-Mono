...
const InvoiceDetailModal = ({ invoice: initialInvoice, onClose }: { invoice: Invoice; onClose: () => void }) => {
  ...
  <div className="w-10 h-10  flex items-center justify-center" style={{ backgroundColor: isProforma ? '#f59e0b15' : `${STATUS_COLORS[invoice.status]}15` }}>
  ...
  className="flex-1 bg-gray-50  border border-gray-200 px-3 py-2 text-xs text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc]"
  />
  <input
  type="number"
  value={it.quantity}
  onChange={e => updateEditItem(idx, 'quantity', e.target.value)}
  className="w-16 bg-gray-50  border border-gray-200 px-3 py-2 text-xs text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc]"
  />
  <input
  type="number"
  value={it.unitPrice}
  ...
  placeholder="Prix"
  className="w-28 bg-gray-50  border border-gray-200 px-3 py-2 text-xs text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc]"
  />
  ...
  rows={2}
  className="w-full bg-gray-50  border border-gray-200 px-3 py-2 text-xs text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#33cbcc]/30 focus:border-[#33cbcc] resize-none"
  />
  </div>
  </div>
  ) : (
  ...
  {/* Footer Actions */}
  <div className="px-6 py-4 border-t border-[#e5e8ef] shrink-0 space-y-3">
  {isEditing ? (
  ...
  className="flex items-center gap-2 px-5 py-2  text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2bb5b6] transition-colors disabled:opacity-50"
  >
  ...
  className="flex items-center gap-2 px-4 py-2  text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors disabled:opacity-50"
  >
  ...
  className="flex items-center gap-2 px-4 py-2  text-sm font-medium text-[#283852] bg-[#283852]/10 hover:bg-[#283852]/20 transition-colors disabled:opacity-50"
  >
  ...
  className="flex items-center gap-1.5 px-3 py-2  text-sm font-medium text-[#283852] bg-[#283852]/10 hover:bg-[#283852]/20 transition-colors disabled:opacity-50"
  >
  ...
  className="flex items-center gap-1.5 px-4 py-2  text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2bb5b6] transition-colors shadow-lg shadow-[#33cbcc]/20 disabled:opacity-50"
  >
  ...
  className="flex items-center gap-1.5 px-4 py-2  text-sm font-semibold text-white bg-[#283852] hover:bg-[#283852]/80 transition-colors shadow-lg shadow-[#283852]/20 disabled:opacity-50"
  >
  ...
  className="flex items-center gap-1.5 px-3 py-2  text-sm font-medium text-[#33cbcc] bg-[#33cbcc]/10 hover:bg-[#33cbcc]/20 transition-colors"
  >
  <Add01Icon size={14} />
  Acompte
  </button>
  ...
  >
  <div className="px-6 py-5 border-b border-[#e5e8ef] flex items-center gap-3 shrink-0">
  <div className="p-2.5  bg-[#33cbcc]/10">
  <Add01Icon size={20} className="text-[#33cbcc]" />
  </div>
  <h3 className="text-base font-semibold text-[#1c2b3a]">Facture d'acompte</h3>
  </div>
  <div className="p-6 flex-1 overflow-y-auto space-y-4">
  <p className="text-sm text-[#8892a4]">
  Montant total de la facture : <span className="text-[#1c2b3a] font-semibold">{formatCurrency(Number(invoice.total))}</span>
  </p>
  <div>
  <label className="block text-[10px] font-semibold text-[#8892a4] uppercase tracking-wider mb-1.5">Montant de l'acompte</label>
  <input
  type="number"
  min="1"
  ...
  <button onClick={() => { setShowAcompteModal(false); setAcompteAmount(''); }} className="flex-1 py-3 text-sm font-semibold text-[#8892a4] border border-[#e5e8ef] hover:border-[#283852] hover:text-[#283852] transition-colors">
  Annuler
  </button>
  <button
  ...
  className="flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold text-white bg-[#33cbcc] hover:bg-[#2bb5b6] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
  >
  ...
  <h3 className="text-base font-semibold text-[#1c2b3a]">{t('invoices.detail.pay')}</h3>
  </div>
  <div className="p-6 flex-1 overflow-y-auto">
  <p className="text-sm text-[#8892a4]">{t('invoices.detail.confirmPay')}</p>
  </div>
  <div className="px-6 py-4 border-t border-[#e5e8ef] flex gap-3">
  <button
  onClick={() => setShowConfirmPay(false)}
  ...
  <h3 className="text-base font-semibold text-[#1c2b3a]">Valider la proforma</h3>
  </div>
  <div className="p-6 flex-1 overflow-y-auto">
  <p className="text-sm text-[#8892a4]">Cette proforma sera convertie en facture avec un numéro de facture définitif. Cette action est irréversible.</p>
  </div>
  <div className="px-6 py-4 border-t border-[#e5e8ef] flex gap-3">
  <button
  onClick={() => setShowConfirmValidate(false)}
...
const Invoices = () => {
  ...
  {activeTab === 'invoices' && (
  <button onClick={() => setShowCreateModal(true)} className="flex items-center gap-2 bg-[#33cbcc] text-white px-5 py-2.5  text-sm font-semibold hover:bg-[#2bb5b6] transition-colors shadow-lg shadow-[#33cbcc]/20">
  <Add01Icon size={16} />{t('invoices.newInvoice')}
  </button>
  )}
  {activeTab === 'proformas' && (
  <button onClick={() => setShowCreateProformaModal(true)} className="flex items-center gap-2 bg-[#33cbcc] text-white px-5 py-2.5  text-sm font-semibold hover:bg-[#2bb5b6] transition-colors shadow-lg shadow-[#33cbcc]/20">
  ...
  className={`flex items-center gap-2 px-5 py-2  text-sm font-semibold transition-all ${activeTab === 'acomptes' ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
  >
  ...
  className="bg-white p-6  border border-gray-100 relative overflow-hidden"
  >
  ...
  <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3 }} className="bg-white p-6  border border-gray-100">
  ...
  <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.4 }} className="bg-white p-6  border border-gray-100">
  ...
  className={`flex items-center gap-2 px-4 py-2  text-sm font-medium transition-colors ${filterStatus === sf.key ? 'bg-[#33cbcc] text-white shadow-lg shadow-[#33cbcc]/20' : 'bg-white text-gray-600 border border-gray-100 hover:border-[#33cbcc]/30'}`}
  >
