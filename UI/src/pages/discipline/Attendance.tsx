...
const Attendance = () => {
  ...
  className="flex items-center gap-2 px-4 py-2.5 bg-[#33cbcc] hover:bg-[#2bb5b6] text-white font-semibold  text-sm transition-colors disabled:opacity-60"
  >
  {upload.isPending ? (
  ...
  <div className="flex items-center gap-2 bg-white border border-gray-200  px-3 py-2 flex-1 min-w-[220px] max-w-md">
  ...
  className="flex items-center gap-2 px-3 py-2 border border-[#ef4444]/30 text-[#ef4444] hover:bg-[#ef4444]/5  text-sm font-medium transition-colors"
  >
  ...
  className="border border-[#e5e8ef]  overflow-hidden bg-white"
  >
  ...
  <div className="h-8 w-40 bg-gray-100  shrink-0" />
  <div className="h-8 w-24 bg-gray-100  shrink-0" />
  {[...Array(10)].map((_, j) => (
  ...
  <div className="w-16 h-16  bg-[#33cbcc]/10 flex items-center justify-center mx-auto mb-4">
...
const ChampionCard = ({
  ...
  <div
  className="w-14 h-14  flex items-center justify-center font-bold text-lg shrink-0"
